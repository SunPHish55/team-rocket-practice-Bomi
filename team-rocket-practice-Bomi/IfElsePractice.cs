        ...
        public static void Menu()
        {
            while (true)
            {
                int q = Menus.KeyboardMenu(
                    ...
                    "1-8：BMI計算。",
                    "2-1：輸出兩數中大的。",
                    "2-2：輸入x和y，如果x和y都是正數，令z=1，如兩者均為負數，令z=-1，否則令z=0。",
                    "2-3：輸入x、y、u、v，如果(x + y) > (u + v)，則令 z = x + y，否則令z = u + v。",
                    "2-4：輸入x、y、u、v，如果( ( x + y ) ) / ( ( u + v ) ) >= 2，令 z = x + y，否則令 z = u + v。",
                    "2-5：輸入x和y，如果x >= y，令z = x ^ 2，否則令 z = y ^ 2。",
                    "2-6：讀入收入並根據收入及稅率計算稅額。",
                    "2-7：象限判斷。",
                    "ex2-1：分數計算。",
                    "ex2-2：BMI計算器plus。",
                    "ex2-3：隨意輸入三個數，由大到小依序印出。",
                    "ex2-4：獎金計算。",
                    "ex2-4-update",
                    "回主選單"
                    },
                    "If Else Practice（CH 1, 2）"
                );
