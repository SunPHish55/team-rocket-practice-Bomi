        ...
        public static void Menu()
        {
            while (true)
            {
                int q = Menus.KeyboardMenu(
                    ...
                    "3-4：輸入10個整數，列出其中所有大於12的數字的總和。",
                    "3-5：輸入N個數字，求其中奇數的最大值。",
                    "3-6：輸入N個數字，求其中所有正數之平方和。",
                    "3-7：輸入N個數字，將其中的負數轉換成正數。",
                    "ex3-1：判斷101-200之間有多少個質數，並輸出所有質數。",
                    "ex3-1-while",
                    "ex3-2：輸入一個數，輸出其質因數。",
                    "ex3-2-while",
                    "ex3-3：求100到300中可以被3與7整除的個數。",
                    "ex3-3-while",
                    "4-1：利用while求N個數字的最大值。",
                    "4-2：利用 while 計算等差級數總和：輸入起始值、公差與項數 N。",
                    "4-3：利用while 讀入N個數字，然後找出所有小於13的數字和。",
                    "4-4：利用while 讀入N個數字，找到第一個大於7而小於10的數字就停止並列印此數。",
                    "4-5：利用while 讀入a1,a2,…,a5和b1,b2,…,b5。找到第一個ai>bi，即停止，並列印出ai及bi。",
                    "ex4-1：每五分鐘可以吃一個39元漢堡，印出吃漢堡紀錄。",
                    "ex4-2：房貸560萬，每個月可還4萬，每還12個月可以多還一萬，請問需要幾個月還清。",
                    "ex4-3：猜數字遊戲。",
                    "bonus 1：客製化聖誕樹。",
                    "bonus 2：找出費氏數列第Ｎ項。",
                    "回主選單"
                    },
                    "Loop Practice（CH 3, 4）"
                );
                ...
                switch (q)
                {
                    ...
                    case 6: Q3_7(); break;
                    case 7: ex3_1(); break;
                    case 8: ex3_1_while(); break;
                    case 9: ex3_2(); break;
                    case 10: ex3_2_while(); break;
                    case 11: ex3_3(); break;
                    case 12: ex3_3_while(); break;
                    case 13: Q4_1(); break;
                    case 14: Q4_2(); break;
                    case 15: Q4_3(); break;
                    case 16: Q4_4(); break;
                    ...
                    case 19: ex4_2(); break;
                    case 20: ex4_3(); break;
                    case 21: bonus_1(); break;
                    case 22: bonus_2(); break;
                    default: return; // 回主選單
                }
            }
        }
